...
const dbo = require('./user/js/databaseOps');

// Promises-wrapped version of sqlite3
const db = require('./user/js/sqlWrap');
...
// const hiddenClientSecret = process.env['594142367442-4d8rd0fa2o1b3js3uvvmidbqtnedjdp0.apps.googleusercontent.com']
// const mySecret = process.env['594142367442-4d8rd0fa2o1b3js3uvvmidbqtnedjdp0.apps.googleusercontent.com']
